...
<\body>
  <\active*>
    <\src-title>
      <src-style-file|tmbook-kovzol|1.0>
  ...
  <assign|chapter-numbered-title|<macro|title|<style-with|src-compact|none|<chapter-long-title|<the-chapter>.<strong| >fejezet|<arg|title>>>>>

  <assign|appendix-numbered-title|<macro|title|<style-with|src-compact|none|<chapter-long-title|<the-appendix>.<strong| ><appendix-text>|<arg|title>>>>>
